function Handle = InitializeGrip(DeviceName, Channels, COM)
...
%
% COM: We use COM3 in the fMRI computer instead of COM1 => COM = [] means
% use the default option, any other value means use this COM port
%
